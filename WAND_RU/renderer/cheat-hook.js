...
(function () {
  ...
  function resolveGameId(doc, fallbackGameId) {
  ...
  function syncBadge(doc, games, fallbackGameId) {
  ...
  function arm(win, games, getFallbackGameId) {
