...
- 🎮 **Перевод читов** - названия читов (`Unlimited Health` → `Бесконечное здоровье`) переводятся
  на лету, в онлайн-режиме - и **описания/заметки** читов. Два режима - см. ниже.
...
- **Русифицировать локально + интернет** - то же, плюс всё непокрытое словарём допереводится онлайн
  и кэшируется, **включая описания и заметки читов**. Переводит практически всё. Провайдеры бесплатные
  и без ключей: **Google Translate**, при его сбое - **MyMemory** (сервис можно выбрать в настройках),
  при недоступности обоих - офлайн-фолбэк (текст останется на английском и переведётся в следующий раз).
  Кэш можно очистить в настройках, там же виден его размер.
